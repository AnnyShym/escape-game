    ...
    public class ObservableTests
    {
        ...
        public void Observable_Where_Constructor_Parameter_X_LessThan_Zero()
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(-1, 100, 1000, 500, 10, 3, new Publisher()));
        }
        ...
        {
            try {
                Observable observable = new Observable(0, 100, 1000, 500, 10, 3, new Publisher());
            }
            catch (Exception ex) {
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(50, -1, 1000, 500, 10, 3, new Publisher()));
        }
        ...
        {
            try {
                Observable observable = new Observable(50, 0, 1000, 500, 10, 3, new Publisher());
            }
            catch (Exception ex) {
                Assert.Fail("Expected no exception, but got: " + ex.Message);
            }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(50, 100, -1, 500, 10, 3, new Publisher()));
        }
        ...
        {
            try {
                Observable observable = new Observable(0, 0, 0, 500, 10, 3, new Publisher());
            }
            catch (Exception ex) {
                Assert.Fail("Expected no exception, but got: " + ex.Message);
            }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(50, 100, 1000, -1, 10, 3, new Publisher()));
        }
        ...
        {
            try {
                Observable observable = new Observable(0, 0, 1000, 0, 10, 3, new Publisher());
            }
            catch (Exception ex) {
                Assert.Fail("Expected no exception, but got: " + ex.Message);
            }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(50, 100, 10, 100, 10, 3, new Publisher()));
        }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(50, 100, 50, 10, 10, 3, new Publisher()));
        }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(50, 100, 10, 10, 10, 3, new Publisher()));
        }
        ...
        {
            try {
                Observable observable = new Observable(50, 100, 50, 100, 10, 3, new Publisher());
            }
            catch (Exception ex) {
                Assert.Fail("Expected no exception, but got: " + ex.Message);
            }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(50, 100, 1000, 500, 0, 3, new Publisher()));
        }
        ...
        {
            try {
                Observable observable = new Observable(50, 100, 1000, 500, 1, 3, new Publisher());
            }
            catch (Exception ex) {
                Assert.Fail("Expected no exception, but got: " + ex.Message);
            }
        ...
        {
            Assert.ThrowsException<ArgumentOutOfRangeException>(
                () => new Observable(50, 100, 1000, 500, 10, -1, new Publisher()));
        }
        ...
        {
            try {
                Observable observable = new Observable(50, 100, 1000, 500, 10, 0, new Publisher());
            }
            catch (Exception ex) {
                Assert.Fail("Expected no exception, but got: " + ex.Message);
            }
        ...
        public void Observable_Where_Constructor_Parameter_Publisher_Is_Null()
        {
            Assert.ThrowsException<ArgumentNullException>(
                () => new Observable(50, 100, 1000, 500, 10, 3, null));
        }
        ...
        {
            try {
                Observable observable = new Observable(50, 100, 1000, 500, 10, 3, new Publisher());
            }
            catch (Exception ex) {
                Assert.Fail("Expected no exception, but got: " + ex.Message);
            }
        ...
        {
            Observable observable = new Observable(0, 0, 1000, 500, 10, 3, new Publisher());
            Assert.ThrowsException<ArgumentOutOfRangeException>(
        ...
        public void Observable_Where_Move_Parameter_Direction_Is_Up_And_TheBorder_DoesNot_Interfere()
        {
            ...
            Observable observable = new Observable(50, 10, 1000, 500, 10, 3, new Publisher());
        ...
        public void Observable_Where_Move_Parameter_Direction_Is_Up_And_TheBorder_Interferes()
        {
            ...
            Observable observable = new Observable(50, 9, 1000, 500, 10, 3, new Publisher());
            observable.Move(DirectionType.Up, 1000, 500);
        ...
        public void Observable_Where_Move_Parameter_Direction_Is_Down_And_TheBorder_DoesNot_Interfere()
        {
            ...
            Observable observable = new Observable(50, 490, 1000, 500, 10, 3, new Publisher());
        ...
        public void Observable_Where_Move_Parameter_Direction_Is_Down_And_TheBorder_Interferes()
        {
            ...
            Observable observable = new Observable(50, 491, 1000, 500, 10, 3, new Publisher());
            observable.Move(DirectionType.Down, 1000, 500);
        ...
        public void Observable_Where_Move_Parameter_Direction_Is_Right_And_TheBorder_DoesNot_Interfere()
        {
            ...
            Observable observable = new Observable(990, 100, 1000, 500, 10, 3, new Publisher());
        ...
        public void Observable_Where_Move_Parameter_Direction_Is_Right_And_TheBorder_Interferes()
        {
            ...
            Observable observable = new Observable(991, 100, 1000, 500, 10, 3, new Publisher());
            observable.Move(DirectionType.Right, 1000, 500);
        ...
        public void Observable_Where_Move_Parameter_Direction_Is_Left_And_TheBorder_DoesNot_Interfere()
        {
            ...
            Observable observable = new Observable(10, 100, 1000, 500, 10, 3, new Publisher());
        ...
        public void Observable_Where_Move_Parameter_Direction_Is_Left_And_TheBorder_Interferes()
        {
            ...
            Observable observable = new Observable(9, 100, 1000, 500, 10, 3, new Publisher());
            observable.Move(DirectionType.Left, 1000, 500);
